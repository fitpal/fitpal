                ...
                <div className="signup-row">
                  <div className="col-md-8 m-auto">
                    ...
                    <form onSubmit={ this.handleSignUp }>
                      ...
                      <div className="form-group">
                        Zipcode
                        <input type="text" className="form-control form-congrol-lg"  name="zipcode"/>
                      </div>
                      <div className="form-group">
                        Email
                        <input type="text" className="form-control form-congrol-lg"  name="contacts"/>
                      </div>
                      <div className="form-group">
                        Workout Type
                        <input type="text" className="form-control form-congrol-lg" name="workoutType"/>
                      </div>
                      <div className="form-group">
                        Availability
                        <input type="text" className="form-control form-congrol-lg" name="availability"/>
                      </div>
                      <div className="form-group">
                        <button className="btn btn-lg btn-secondary form-control form-congrol-lg">Sign Up</button>
                      </div>
                    </form>
                  </div>
                </div>
